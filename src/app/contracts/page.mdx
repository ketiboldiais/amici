...
- Under the UCC, any “expression of acceptance” or “written confirmation” is an acceptance, even if the expression or writing contains different or additional terms.
	...
	- ~Special Treatment of Additional Terms.~ If the offeree responds with an acceptance including additional terms, then a __battle of the forms__ occurs:
		1. If any party is not a merchant, then each additional term is considered a __proposal__ and does not become a part of the contract unless the other party assents to the additional term.
